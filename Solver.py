...
class Solver:
    ...
    def LocalSearchForGLS(self, operator):
        random.seed(1)
    ...
    def StoreBestRelocationMoveForGLS(self, originRouteIndex, targetRouteIndex, originNodeIndex, targetNodeIndex, moveCost,
